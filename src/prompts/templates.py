...
# Sentiment analysis
SENTIMENT_ANALYSIS_PROMPT = """Analyze the sentiment, emotion, and churn risk of this customer support email.
...
{{
  ...
  "tone": "frustrated" or "confused" or "angry" or "satisfied" or "neutral" or "anxious" or "disappointed" or "threatening",
  "escalation_risk": "low" or "medium" or "high" or "critical",
  "churn_risk": true or false,
  "churn_indicators": ["list of detected signals, e.g. 'mentions competitor', 'threatens to leave', 'repeated complaints'"]
}}

Assessment guidelines:
- sentiment_score: -1.0 = extremely angry/hostile, 0.0 = neutral, 1.0 = very positive/thankful
- escalation_risk "critical": legal threats, safety issues, public complaints, media mentions
- escalation_risk "high": angry repeat customer, large financial impact, explicit escalation demand
- churn_risk true: mentions competitors, threatens to cancel, expresses loss of trust, repeated unresolved issues
- Detect sarcasm (e.g. "Oh great, another outage" = negative despite positive words)
- Detect code-mixed languages (e.g. Hinglish "Yeh service bahut bakwas hai" = negative)"""
